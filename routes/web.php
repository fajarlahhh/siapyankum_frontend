...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::group(['middleware' => ['role_or_permission:administrator|konsultasihukum']], function () {
    ...
    Route::group(['middleware' => ['role_or_permission:administrator|daftarkonsultasihukum']], function () {
