...
class PtunController extends Controller
{
	...
	public function hapus($id)
	{
		try{
			...
			return response()->json([
				'swal_pesan' => 'Berhasil menghapus data pendapat saran hukum '.$ptun->bantuan_hukum_laporan_nomor,
	...
	{
		try{
			$ptun = BantuanHukumProses::where('bantuan_hukum_id', $id)->where('bantuan_hukum_proses_status', $status)->delete();
			$data = BantuanHukum::findOrFail($id);
			return response()->json([
