...
@section('content')
    ...
    <div class="row">
        <div class="col-12 mb-2">
            <form action="/lensakegiatan" method="GET" id="frm-cari">
        ...
        <div class="col-12">
            <div class="widget-list widget-list-rounded m-b-30" data-id="widget">
                ...
                <a href="/lensakegiatan/{{ $row->lensa_kegiatan_id }}" class="widget-list-item bg-{{ $warna[rand(0, 11)] }}">
                    <div class="widget-list-content">
                        <h4 class="widget-list-title">{{ $row->lensa_kegiatan_judul }}</h4>
                    </div>
