...
@section('content')
	<div class="row">
        <div class="col-4">
            ...
            <a href="/frontend/pendapatsaran" class="col-12 text-center btn btn-lg mb-4" style="line-height: 40px; height: 150px; background: #8af5ff; border-color: #8af5ff; ">
        ...
        <div class="col-4 text-center">
            ...
            <a href="/frontend/peraturan" class="col-12 text-center btn btn-success btn-lg  mb-4" style="line-height: 40px; height: 150px; padding-top: 30px;">
