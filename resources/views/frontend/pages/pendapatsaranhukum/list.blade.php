            ...
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        <td><label>{{ ++$i }}</label></td>
                        <td>
                            <a href="/frontend/pendapatsaran/{{ $row->pendapat_saran_id }}" class="text-justify">
                                <h5>{{ $row->pendapat_saran_laporan_nomor }} - {{ $row->pendapat_saran_judul }}
                                    <br>
                                    <small>
                                        Status : {{ $row->proses->first()->pendapat_saran_proses_status }}
