...
@section('title', ' | '.$aksi.' Bantuan Hukum / Pidana')
...
@section('page')
	<li class="breadcrumb-item">Pidana</li>
	<li class="breadcrumb-item active">{{ $aksi }} Data</li>
@endsection

@section('header')
	<h1 class="page-header">Bantuan Hukum / Pidana <small>{{ $aksi }} Data</small></h1>
@endsection
...
@section('subcontent')
	<div class="panel panel-inverse" data-sortable-id="form-stuff-1">
		...
		<form action="{{ route('pidana.'.strtolower($aksi)) }}" method="post" data-parsley-validate="true" data-parsley-errors-messages-disabled="">
