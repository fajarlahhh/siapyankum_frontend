...
@section('title', ' | Bantuan Hukum / Pidana')

@section('page')
	<li class="breadcrumb-item active">Pidana</li>
@endsection
...
@section('header')
	<h1 class="page-header">Bantuan Hukum / Pidana</h1>
@endsection
			...
			<div class="row">
                <div class="col-md-4 col-lg-5 col-xl-3 col-xs-12">
                    <div class="form-inline">
                        <a href="{{ route('pidana.tambah') }}" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Tambah</a>
                    </div>
                </div>
                <div class="col-md-8 col-lg-7 col-xl-9 col-xs-12">
                	<form action="{{ route('pidana') }}" method="GET" id="frm-cari">
				...
				<table class="table table-hover">
					...
					<tbody>
					    ...
					    <tr>
					        ...
					        <td class="pull-right">
                                <a href="/pidana/proses/{{ $row->bantuan_hukum_id }}" id='btn-del' class='btn btn-success btn-xs m-r-3'><i class='fas fa-paper-plane'></i> Ganti Status</a><br><br>
                                <a href="/pidana/edit/{{ $row->bantuan_hukum_id }}" id='btn-del' class='btn btn-grey btn-xs m-r-3'><i class='fas fa-edit'></i> Edit Data</a>
...
<script src="/assets/plugins/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
	<script>
		...
		function hapus(id, nama) {
			swal({
				title: 'Hapus Data',
				text: 'Anda akan menghapus bantuan hukum pidana : ' + nama ,
				icon: 'warning',
				buttons: {
					cancel: {
						text: 'Batal',
