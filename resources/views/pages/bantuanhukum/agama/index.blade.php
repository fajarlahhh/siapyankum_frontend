				...
				<table class="table table-hover">
					...
					<tbody>
					    ...
					    <tr>
					        ...
					        <td>
					        	@role('user|administrator')
                                <a href="/agama/proses/{{ $row->bantuan_hukum_id }}" id='btn-del' class='btn btn-success btn-xs m-r-3'><i class='fas fa-paper-plane'></i></a>
                                @if ($row->proses->count() > 0 && $row->proses[0]->bantuan_hukum_proses_status != 'PUTUSAN SIDANG')
                                <a href="/agama/edit/{{ $row->bantuan_hukum_id }}" id='btn-del' class='btn btn-grey btn-xs m-r-3'><i class='fas fa-edit'></i></a>
