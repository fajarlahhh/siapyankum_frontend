...
@section('page')
	<li class="breadcrumb-item active">PTUN</li>
@endsection
...
@section('header')
	<h1 class="page-header">Bantuan Hukum / PTUN</h1>
@endsection
				...
				<table class="table table-hover">
					...
					<tbody>
					    ...
					    <tr>
					        ...
					        <td>
					        	@role('user|administrator')
                                <a href="/ptun/proses/{{ $row->bantuan_hukum_id }}" id='btn-del' class='btn btn-success btn-xs m-r-3'><i class='fas fa-paper-plane'></i></a>
                                @if ($row->proses->count() > 0 && $row->proses[0]->bantuan_hukum_proses_status != 'PUTUSAN SIDANG')
                                <a href="/ptun/edit/{{ $row->bantuan_hukum_id }}" id='btn-del' class='btn btn-grey btn-xs m-r-3'><i class='fas fa-edit'></i></a>
